...
const BuyCredit = () => {
  ...
  return (
    <motion.div className='flex flex-col w-full justify-center items-center mt-24 space-y-5' initial={{opacity:0.2, y:100}} transition={{duration:0.5}} whileInView={{opacity:1, y:0}}>
      ...
      <div className='flex flex-col lg:flex-row w-full p-6 gap-8 items-center justify-center'>
        {
          plansData.map((item, index)=>(
            <div key={index} className='bg-white w-full max-w-sm rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-300'>
